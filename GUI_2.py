...
def show():
    ...
    if(index==-1):
        ...
        Productlabel = Label(root, text="Quantity in the store").grid(row=7, column=0)
...
def showProducer():
    ...
    if(index==-1):
        ...
        Productlabel1 = Label(root, text="Quantity in the producer").grid(row=8, column=0)
...
def placeOrder():
    ...
    if(index==-1):
        ...
        Orderlabel = Label(root, text="Quantity to order").grid(row=10, column=0)
    
        OrderEntry = Entry(root, textvariable = amount, width = 10).grid(row=10, column=1)
...
def order():
    ...
    if(TheAmount==""):
        ...
        filename = '/Users/justi/Desktop/IoT/Assignment_2/Inventory-Management/Store.csv'
...
def cancel():
        listbox1.config(state="normal")
        button1.config(state="normal")  
        #Orderlabel.config(text="")
        #OrderEntry.set("")
        #amountlabel1.text.set("Text updated")
        #amountlabel.text.set("Text updated")
        #btn2.pack_forget()
        #button3.pack_forget()
...
#-----------------------------------------------------------------------------------------------
File = open('/Users/justi/Desktop/IoT/Assignment_2/Inventory-Management/Store.csv')
